...
namespace DVLD_Business
{
    public class clsInternationalLicense : clsApplication
    {
        ...
        private bool _AddNewInternationalLicense()
        {
            ...
            this.InternationalLicenseID =clsInternationalData.AddNewInternationalLicense(this.ApplicationID, this.DriverID, this.IssuedUsingLocalLicenseID,
        ...
        {
            return clsInternationalData.UpdateInternationalLicense(this.InternationalLicenseID, this.ApplicationID, this.DriverID, this.IssuedUsingLocalLicenseID,
               this.IssueDate, this.ExpirationDate,
               this.IsActive, this.CreatedByUserID);
        }
        ...
        public static clsInternationalLicense Find(int InternationalLicenseID)
        {
            ...
            if (clsInternationalData.GetInternationalLicenseInfoByID(InternationalLicenseID, ref ApplicationID, ref DriverID,ref IssuedUsingLocalLicenseID,
        ...
        public static int GetActiveInternationalLicenseIDByDriverID(int DriverID)
        {
            ...
            return clsInternationalData.GetActiveInternationalLicenseIDByDriverID(DriverID);
